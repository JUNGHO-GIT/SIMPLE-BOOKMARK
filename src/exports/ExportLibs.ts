...
// 2. export ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――--
export { _createRequire as createRequire, _fs as fs, _http as http, _https as https, _Minimatch as Minimatch, _os as os, _path as path, _TextEncoder as TextEncoder, _vscode as vscode };
